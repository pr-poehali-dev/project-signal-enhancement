...
const ARCANA = [
  {
    number: "0",
    name: "Шут",
    subtitle: "Аркан начала",
    symbol: "✦",
    quote: ["«Первый шаг всегда ", "делается вслепую.»"],
    text: "Этот аркан выпал тебе не случайно. Ты стоишь на пороге чего-то нового — и внутри смесь страха и азарта. Не жди идеального момента. Он уже здесь. Доверься движению.",
  },
  {
    number: "I",
    name: "Маг",
    ...
    text: "Ты сильнее, чем думаешь. Сейчас — время действовать, а не ждать разрешения. Всё, что казалось невозможным, становится доступным, если ты перестанешь сомневаться в своих силах.",
  },
  {
    number: "II",
    ...
    symbol: "☽",
    quote: ["«Ты уже знаешь ответ. ", "Просто боишься его принять.»"],
    text: "Внутри тебя живёт знание, которое ты глушишь логикой и чужими советами. Остановись. Прислушайся. То, что ты чувствуешь — правда. Жрица говорит: доверяй себе.",
  },
  {
    number: "III",
    name: "Императрица",
    subtitle: "Аркан изобилия",
    symbol: "♀",
    quote: ["«Пора перестать экономить ", "на себе.»"],
    text: "Этот аркан — про твою ценность. Ты давно отдаёшь больше, чем получаешь. Сейчас время наполниться самой: своими желаниями, своей красотой, своей жизнью. Ты заслуживаешь большего.",
  },
  {
    number: "IV",
    name: "Император",
    subtitle: "Аркан порядка",
    symbol: "♂",
    quote: ["«Возьми жизнь в свои руки — ", "или кто-то возьмёт её за тебя.»"],
    text: "Сейчас нужна структура и твёрдость. Там, где ты уступаешь — теряешь позиции. Время навести порядок: в отношениях, в делах, в голове. Ты способен на это.",
  },
  {
    number: "V",
    name: "Иерофант",
    subtitle: "Аркан пути",
    symbol: "♃",
    quote: ["«Истина не снаружи — ", "она ждёт внутри.»"],
    text: "Ты ищешь ответы в чужих словах, книгах, советах. Но этот аркан говорит: пора прийти к собственному пониманию. Есть вопрос, который давно требует честного разговора с собой.",
  },
  {
    number: "VI",
    name: "Влюблённые",
    subtitle: "Аркан выбора",
    symbol: "☊",
    quote: ["«Выбор, который ты откладываешь, ", "уже делается без тебя.»"],
    text: "Этот аркан о выборе, который зреет. В отношениях, в сердце, в жизни. Ты знаешь, чего хочешь — но страшно признаться. Время честности с собой пришло. Ответ уже есть.",
  },
  {
    number: "VII",
    name: "Колесница",
    subtitle: "Аркан движения",
    symbol: "⊕",
    quote: ["«Ты едешь вперёд — ", "даже если кажется, что стоишь.»"],
    text: "Внутри тебя больше силы, чем видно снаружи. Ты держишь слишком много одновременно, но справляешься. Этот период — не тупик. Это разгон. Скоро всё встанет на место.",
  },
  {
    number: "VIII",
    name: "Сила",
    subtitle: "Аркан силы",
    symbol: "∞",
    quote: ["«Настоящая сила — ", "это мягкость без страха.»"],
    text: "Ты устала бороться. Но этот аркан говорит не о борьбе — он о спокойной уверенности. Ты не обязана кричать, чтобы тебя услышали. Твоя тихая сила сейчас мощнее любого давления.",
  },
  {
    number: "IX",
    name: "Отшельник",
    subtitle: "Аркан одиночества",
    symbol: "⟡",
    quote: ["«Иногда нужно уйти в тишину, ", "чтобы услышать главное.»"],
    text: "Тебе сейчас нужно пространство. Не бегство — именно пространство. Чтобы разобраться, что твоё, а что навязано. Отшельник — не про изоляцию. Он про честный разговор с собой.",
  },
  {
    number: "X",
    name: "Колесо Фортуны",
    subtitle: "Аркан перемен",
    symbol: "☸",
    quote: ["«Всё меняется. Особенно то, ", "что казалось вечным.»"],
    text: "Колесо крутится — и сейчас в твоей жизни что-то меняется или вот-вот изменится. Это не катастрофа. Это момент, когда судьба открывает новую дверь. Важно не цепляться за старое.",
  },
  {
    number: "XI",
    name: "Справедливость",
    ...
    symbol: "⚖",
    quote: ["«Правда всегда выходит наружу — ", "рано или поздно.»"],
    text: "Если тебя предали, обманули или обошлись несправедливо — этот аркан говорит: баланс восстановится. Не нужно мстить. Всё уже учтено. А тебе пора отпустить и двигаться дальше.",
  },
  {
    number: "XII",
    name: "Повешенный",
    ...
    symbol: "∇",
    quote: ["«Остановка — ", "это не слабость, это мудрость.»"],
    text: "Ты сейчас в паузе — и это правильно. Не толкай ситуацию силой. Именно сейчас, когда всё замерло, видно то, чего не видно в движении. Твой следующий шаг откроется сам.",
  },
  {
    number: "XIII",
    name: "Смерть",
    subtitle: "Аркан завершения",
    symbol: "⌖",
    quote: ["«Что-то заканчивается, ", "чтобы ты наконец-то начала жить.»"],
    text: "Не бойся этого аркана. Он не о смерти тела — он о смерти того, что давно тебя тяготит. Отношения, роль, убеждение, страх. Пришло время отпустить. За этим порогом — свобода.",
  },
  {
    number: "XIV",
    name: "Умеренность",
    subtitle: "Аркан баланса",
    symbol: "☯",
    quote: ["«Не надо всё и сразу. ", "Надо — правильно.»"],
    text: "Этот аркан — про исцеление через терпение. Ты торопишь события, а нужно — позволить им созреть. Найди середину между желанием и реальностью. Там и живёт твой ответ.",
  },
  {
    number: "XV",
    name: "Дьявол",
    ...
    symbol: "♄",
    quote: ["«Ты держишься за то, ", "что давно тебя не держит.»"],
    text: "Что-то или кто-то забирает твою энергию — и ты это чувствуешь, но продолжаешь. Этот аркан говорит прямо: это не любовь и не долг. Это привязанность. Пора увидеть замок и открыть его.",
  },
  {
    number: "XVI",
    name: "Башня",
    subtitle: "Аркан разрушения",
    symbol: "⚡",
    quote: ["«То, что рушится — ", "не должно было стоять.»"],
    text: "Что-то в твоей жизни трещит по швам. И это не катастрофа — это расчистка. Башня рушится не чтобы тебя уничтожить, а чтобы убрать то, что стояло на лжи. После — строится настоящее.",
  },
  {
    number: "XVII",
    name: "Звезда",
    subtitle: "Аркан надежды",
    symbol: "★",
    quote: ["«После самой тёмной ночи ", "именно звёзды видны лучше всего.»"],
    text: "Ты прошла через что-то тяжёлое — и выжила. Этот аркан говорит: теперь начинается твоё время. Надежда не наивная — она заработанная. Верь. Небо уже открывается.",
  },
  {
    number: "XVIII",
    name: "Луна",
    ...
    symbol: "☾",
    quote: ["«Не всё, что блестит в темноте, ", "является светом.»"],
    text: "Вокруг тебя сейчас есть что-то ненастоящее: слова, которые звучат красиво, но ощущаются пусто. Доверяй ощущениям, а не картинке. Луна открывает то, что прячется за красивым фасадом.",
  },
  {
    number: "XIX",
    name: "Солнце",
    subtitle: "Аркан радости",
    symbol: "☀",
    quote: ["«Ты заслуживаешь не просто счастья — ", "ты заслуживаешь лёгкости.»"],
    text: "Солнце — лучший аркан. Он говорит: впереди ясность, тепло и то, чего ты так долго ждала. Позволь себе радоваться без оговорок. Хорошее — уже идёт к тебе. Открой дверь.",
  },
  {
    number: "XX",
    name: "Суд",
    subtitle: "Аркан пробуждения",
    symbol: "℃",
    quote: ["«Пора проснуться ", "и увидеть себя настоящей.»"],
    text: "Этот аркан — звонок. Пробуждение. Что-то в тебе давно хотело выйти на поверхность — какое-то решение, признание, поворот. Сейчас момент. Не откладывай разговор с собой на потом.",
  },
  {
    number: "XXI",
    name: "Мир",
    subtitle: "Аркан завершённости",
    symbol: "◎",
    quote: ["«Ты пришла туда, ", "куда шла.»"],
    text: "Этот аркан — редкий и сильный. Он говорит о завершении цикла и о том, что ты справилась. Что бы ни происходило сейчас — ты на правильном пути. Всё складывается. Доверяй.",
  },
]
