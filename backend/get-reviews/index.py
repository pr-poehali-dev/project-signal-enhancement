...
def handler(event: dict, context) -> dict:
    """Возвращает список одобренных отзывов для отображения на сайте."""
    cors = {
    ...
    sql = f"SELECT id, author, text, stars, created_at FROM {schema}.reviews WHERE status = 'approved' ORDER BY created_at DESC"
